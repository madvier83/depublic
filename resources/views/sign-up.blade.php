<x-layout>
    <x-slot:title>Depublic - Sign Up</x-slot:title>
    <x-navbar></x-navbar>
    ...
    <div class="w-full min-h-screen max-w-[576px] mx-auto relative bg-[#FAFAFA]">
        <div class="flex px-8 items-center justify-between w-[576px] h-[80px] bg-[#FDF9F0] z-0">
            <h1 class="text-[20px] font-bold">Sign Up</h1>
            <a href="/">
        ...
        <div class="p-8">
            ...
            <h1 class="text-[20px] font-semibold">Register for the better experience</h1>
            <form action="" class="mt-8">
                ...
                <button class="font-bold btn btn-primary h-[62px] w-full text-[20px] mt-8">Create Account</button>


            </form>
            <div class="text-center mt-8">
                <p class="text-gray-600 mt-2">Have an account? <a href="/sign-in"
                        class="text-primary font-semibold">Login</a></p>
            </div>
